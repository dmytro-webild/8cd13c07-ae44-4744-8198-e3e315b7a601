...
export default function LandingPage() {
  ...
  <div id="about" data-section="about">
      ...
      title="Náš príbeh"
      description={[
        "Sme tím vášnivých profesionálok, ktoré milujú svoju prácu. Každá klientka odchádza nielen krajšia, ale aj nabitá dobrou náladou.",
        "Útulné prostredie, úprimnú radosť z každého účesu a kávičku zadarmo — to sú naše sľuby, ktoré vždy dodržíme.",
      ]}
    />
  </div>
      ...
      testimonials={[
        {
          ...
          name: "Iveta C.",
          handle: "Klientka",
          testimonial: "Úžasné babenky, vždy odtiaľ chodím spokojná.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Katarína C.",
          handle: "Klientka",
          testimonial: "Super kaderníctvo, kaderníčky sú profesionálky.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Anna V.",
          handle: "Klientka",
          testimonial: "Tento salón je vynikajúci, prácu si vykonávajú poctivo.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Veronika P.",
          handle: "Klientka",
          testimonial: "Najlepšie kaderníctvo! Príjemné prostredie.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Tatiana P.",
          handle: "Klientka",
          testimonial: "Milé kaderníčky, profesionálna starostlivosť.",
          rating: 5,
  ...
  <div id="footer" data-section="footer">
      ...
      logoText="Isle of Beauty"
      leftLink={{
        text: "Kontakt: Trnovec nad Váhom",
        href: "#contact",
      }}
      rightLink={{
        text: "© 2026 Isle of Beauty",
        href: "#",
      }}
    />
  </div>
